...
namespace health_care
{
    public partial class create_doctor : Form
    {
        ...
        private void sumbitd_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("addd__doctor", con);
        ...
        private void nod_label_Click(object sender, EventArgs e)
        {

        }
      

        private void passwordD_textbox_TextChanged(object sender, EventArgs e)
        {
           
            this.passwordD_textbox.ForeColor = System.Drawing.SystemColors.WindowText;
            this.passwordD_textbox.PasswordChar = '♫';
        }
